...
public record EventDto(int Id, string Name, DateOnly Date, bool AllowBusyBee);
public record EventWithSingersDto(int Id, string Name, DateOnly Date, bool AllowBusyBee, List<SingerDto> Singers);
public record CreateEventDto(string Name, DateOnly Date, bool AllowBusyBee = false);
public record UpdateEventDto(string Name, DateOnly Date, bool AllowBusyBee = false);
